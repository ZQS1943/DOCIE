...
def main():
    ...
    source = f'./data/wikievents/10fold/fold_{args.fold_num}/train.jsonl'
    target = f'./{args.data_file}/train_normal.jsonl'
    # train_dataset = IEDataset('preprocessed_KAIROS_info/train.jsonl')    
    get_data_normal(source = source, target = target, tokenizer = tokenizer)
    ...
    target = f'./{args.data_file}/train_tag_other.jsonl'
