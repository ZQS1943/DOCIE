...
from .bart_model_type import BartModelType


class BartConstrainedGenType(PreTrainedModel):
    def __init__(self, config, tokenizer):
        super(BartConstrainedGenType, self).__init__(config)
        self.config = config 
        self.tokenizer = tokenizer 
        self.transformer = BartModelType.from_pretrained('facebook/bart-large')
    ...
    def _generate_no_beam_search(
        ...
        while cur_len < max_length:
            ...
            outputs = self(**model_inputs, token_type=token_type, return_dict=True) 
