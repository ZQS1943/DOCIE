...
def scorer(args):
    ...
    with open(args.constrain_file,'r') as reader:
    ...
    print(constrained_ids, len(constrained_ids))
    for key in tqdm(constrained_ids):
        ex = examples[key]        
...
if __name__ == '__main__':
    ...
    parser.add_argument('--gen-file',type=str,default=f'checkpoints/s-pred-origin/predictions.jsonl' )
    parser.add_argument('--constrain_file',type=str,default=f'checkpoints/two_event/epoch_0_predictions.jsonl')
