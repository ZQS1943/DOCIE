...
if __name__ == '__main__':
    ...
    parser.add_argument('--gen-file',type=str,default=f'checkpoints/two_event/epoch_2_predictions.jsonl' )
    ...
    for idx in range(3,6):
        arg_scorer.gen_file = f'checkpoints/two_event/epoch_{idx}_predictions.jsonl'
        scorer(arg_scorer)
