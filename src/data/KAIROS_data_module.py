...
sys.path.append(os.path.dirname('src/genie/'))
sys.path.append(os.path.dirname('src/data/'))
from data import IEDataset, my_collate, my_collate_event_aware_only_arg
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train-file',type=str,default='data/wikievents/train_no_ontology.jsonl')
    parser.add_argument('--val-file', type=str, default='data/wikievents/dev_no_ontology.jsonl')
    parser.add_argument('--test-file', type=str, default='data/wikievents/test_no_ontology.jsonl')
    parser.add_argument('--data_file', type=str, default='preprocessed_KAIROS')
